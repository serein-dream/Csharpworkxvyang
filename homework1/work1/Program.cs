...
namespace work1
{
    class Program
    {
        static double CheckCanNumber(string number)
        {
            try
            {
            ...
            {
                Console.WriteLine("您的输入有问题，请重新输入：");
                string numberagain = Console.ReadLine();
                return CheckCanNumber(numberagain);
            }
        }
            ...
            switch (s)
            {
                ...
                case '/':
                    if (n == 0)
                    {
                        ...
                        double p = CheckCanNumber(Console.ReadLine());
                        Calculate1(m, p, s);
                    }
                    else
                    {
                ...
                case '%':
                    if (n == 0)
                    {
                        ...
                        double z = CheckCanNumber(Console.ReadLine());
                        Calculate1(m, z, s);
                    }
                    else
                    {
                ...
                default:
                    ...
                    double mm = CheckCanNumber(Console.ReadLine());
                    Console.WriteLine("请输入第二个运算数： ");
                    double nn = CheckCanNumber(Console.ReadLine());
                    Calculate1(mm, nn, ss);
                    break;
            }
        }
        static void Main(string[] args)
        {
            ...
            while (t == 1)
            {
                ...
                Console.WriteLine("请输入第一个运算数： ");
                double number1 = CheckCanNumber(Console.ReadLine());
                Console.WriteLine("请输入第二个运算数： ");
                double number2 = CheckCanNumber(Console.ReadLine());
