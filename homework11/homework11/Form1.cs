...
namespace homework11
{
    ...
    {
        public OrderService Os = new OrderService("1");
 ...
 */
        ...
        private void Button_deleteOrder_Click(object sender,EventArgs e)
        {
            ...
            Order order = OrderService.QueryById(Convert.ToString(OrderId));
            if (order != null)
            {
                OrderService.Deleteorder(Convert.ToString(OrderId));
            }
        ...
        private void Button_viewbyId_Click(object sender,EventArgs e)
        {
            ...
            else
            {
                ...
                orderBindingSource.DataSource = OrderService.QueryById(Convert.ToString(OrderId));
            }
        }
        ...
        private void Button_modify_click(object sender,EventArgs e)
        {
            ...
            Order theorder = OrderService.QueryById(Convert.ToString(theId));
